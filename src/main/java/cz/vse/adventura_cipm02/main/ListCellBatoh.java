...
/**
 *  Třída, která se stará o zobrazení předmětů v inventáři
 *
 */
public class ListCellBatoh extends ListCell<Vec> {

    /**
     *  Metoda zobrazuje aktuální název a obrázek k danému předmětu v inventáři
     *
     */
    @Override
